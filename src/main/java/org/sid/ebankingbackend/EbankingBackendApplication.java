...
public class EbankingBackendApplication {
    ...
    //@Bean
    CommandLineRunner start(CustomerRespository customerRespository , BankAccountRespository bankAccountRespository , AccountOperationRespository accountOperationRespository){
        return args -> {
            ...
            customerRespository.findAll().forEach(cust -> {
            ...
            bankAccountRespository.findAll().forEach(acc->{
                for(int i=0; i<5; i++){
